...
<main id="main-content" class="site-main site-main--home">
    ...
    <section class="section benefits-section" aria-labelledby="benefits-title">
        <div class="rc-container">
            <header class="benefits-section__heading"><p class="eyebrow"><?php esc_html_e( 'Local service', 'rentacar-venezia-v2' ); ?></p><h2 id="benefits-title"><?php esc_html_e( 'Why choose Rent a Car Venezia?', 'rentacar-venezia-v2' ); ?></h2></header>
            <ul class="benefits-grid">
                <li class="reveal-on-scroll"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M4 20V5l8-3 8 3v15M8 9h.01M16 9h.01M8 13h.01M16 13h.01M10 20v-3h4v3"/></svg><h3><?php esc_html_e( 'Local assistance', 'rentacar-venezia-v2' ); ?></h3><p><?php esc_html_e( 'Speak directly with a local team that reviews your request and explains the available options.', 'rentacar-venezia-v2' ); ?></p></li>
                <li class="reveal-on-scroll"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M6 3h9l3 3v15H6zM15 3v4h3M9 13l2 2 4-4"/></svg><h3><?php esc_html_e( 'No payment to send a request', 'rentacar-venezia-v2' ); ?></h3><p><?php esc_html_e( 'Send your preferred dates and vehicle without making an immediate payment.', 'rentacar-venezia-v2' ); ?></p></li>
                <li class="reveal-on-scroll"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M12 21s7-5.2 7-11a7 7 0 1 0-14 0c0 5.8 7 11 7 11Z"/><circle cx="12" cy="10" r="2"/></svg><h3><?php esc_html_e( 'Pickup in Venice and Treviso', 'rentacar-venezia-v2' ); ?></h3><p><?php esc_html_e( 'Choose Venice Marco Polo Airport, Treviso Airport or a pickup location that suits you.', 'rentacar-venezia-v2' ); ?></p></li>
                <li class="reveal-on-scroll"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M5 12.5 9.5 17 19 7.5"/></svg><h3><?php esc_html_e( 'Personal confirmation', 'rentacar-venezia-v2' ); ?></h3><p><?php esc_html_e( 'Availability, final price and rental conditions are confirmed before the reservation is finalized.', 'rentacar-venezia-v2' ); ?></p></li>
            </ul>
        </div>
    </section>
