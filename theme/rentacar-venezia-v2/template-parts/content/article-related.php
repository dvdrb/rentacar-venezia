...
$related = new WP_Query( array( 'post_type' => 'post', 'posts_per_page' => 3, 'post__not_in' => array( get_the_ID() ), 'ignore_sticky_posts' => true, 'meta_key' => '_rc_seo_indexable', 'meta_value' => '1' ) );
