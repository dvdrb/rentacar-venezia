...
$vehicle_url = add_query_arg( rentacar_venezia_v2_trip_query(), $vehicle->get( 'permalink' ) );
?>
<article class="vehicle-card">
    <a class="vehicle-card__image" href="<?php echo esc_url( $vehicle_url ); ?>">
        <?php
    ...
    <div class="vehicle-card__body"><h3><a href="<?php echo esc_url( $vehicle_url ); ?>"><?php echo esc_html( $vehicle->get( 'title' ) ); ?></a></h3>
        ...
        <a class="button" href="<?php echo esc_url( $vehicle_url ); ?>"><?php esc_html_e( 'View details', 'rentacar-venezia-v2' ); ?></a>
    </div>
</article>
