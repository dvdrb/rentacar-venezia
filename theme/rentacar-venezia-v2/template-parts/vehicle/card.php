...
$variant = in_array( $args['variant'] ?? 'fleet', array( 'featured', 'fleet', 'related', 'compact' ), true ) ? $args['variant'] : 'fleet';
...
?>
<article class="vehicle-card vehicle-card--<?php echo esc_attr( $variant ); ?>">
    ...
    <div class="vehicle-card__body">
        ...
        <div class="vehicle-card__actions">
            <button class="button reservation-trigger" type="button" data-reservation-trigger data-vehicle-id="<?php echo esc_attr( $vehicle->get( 'id' ) ); ?>" data-vehicle-title="<?php echo esc_attr( $title ); ?>" data-vehicle-image="<?php echo esc_url( $image_url ); ?>" data-vehicle-specifications="<?php echo esc_attr( implode( ' · ', $specifications ) ); ?>" data-vehicle-price-bands="<?php echo esc_attr( implode( ' · ', $price_labels ) ); ?>" aria-label="<?php echo esc_attr( sprintf( __( 'Reserve %s', 'rentacar-venezia-v2' ), $title ) ); ?>"><?php esc_html_e( 'Reserve this car', 'rentacar-venezia-v2' ); ?></button>
