...
final class Rentacar_Core_Reservation_Validator {
    public function validate( array $input ) {
        ...
        $airport_locations = array( 'Airport Venice Marco Polo', 'Treviso Airport Arrivals' );
        if ( in_array( $input['pickup_location'] ?? '', $airport_locations, true ) && empty( $input['flight_number'] ) ) $errors->add( 'flight_number', __( 'Please enter your flight number for airport pickup.', 'rentacar-core' ) );
