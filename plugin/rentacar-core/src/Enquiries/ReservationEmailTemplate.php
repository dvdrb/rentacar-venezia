...
final class Rentacar_Core_Reservation_Email_Template {
    ...
    public static function render( $heading, $intro, $reference, array $sections, $footer = '', $language = 'en', $reference_label = 'Reference' ) {
        $content = '';
